...
/*
 * Input structure for the method CreateRecordingListrecording
 */
type CreateRecordingListrecordingInput struct {
 ...
 */
func (me *RECORDING_IMPL) CreateRecordingDeleterecording (
 ...
 * @return	Returns the string response from the API call
 */
func (me *RECORDING_IMPL) CreateRecordingViewrecording (
            recordingsid string) (string, error) {
        //the base uri for api requests
    _queryBuilder := configuration_pkg.BASEURI;
 ...
 * @param  CreateRecordingListrecordingInput     Structure with all inputs
 * @return	Returns the string response from the API call
 */
