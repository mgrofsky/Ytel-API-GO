...
/*
 * Input structure for the method ListTranscription
 */
type ListTranscriptionInput struct {
    ResponseType    string          //Response type format xml or json
    Page            *int64          //page number
    PageSize        *int64          //Amount of data per page
    Status          models_pkg.StatusEnum //Transcription status
    DateTranscribed *string         //Transcription date
}

/*
 * Input structure for the method ViewTranscription
 */
type ViewTranscriptionInput struct {
    TranscriptionSid string          //Unique Transcription ID
    ResponseType     string          //Response type format xml or json
}

/*
 * Input structure for the method RecordingTranscription
 */
type RecordingTranscriptionInput struct {
    RecordingSid    string          //Unique Recording sid
    ResponseType    string          //Response type format xml or json
}

/*
 * Input structure for the method AudioURLTranscription
 */
type AudioURLTranscriptionInput struct {
 ...
 * @param  ListTranscriptionInput     Structure with all inputs
 ...
 * @param  ViewTranscriptionInput     Structure with all inputs
 * @return	Returns the string response from the API call
 */
 ...
 * @param  RecordingTranscriptionInput     Structure with all inputs
 * @return	Returns the string response from the API call
 */
 ...
 * @param  AudioURLTranscriptionInput     Structure with all inputs
 * @return	Returns the string response from the API call
 */
